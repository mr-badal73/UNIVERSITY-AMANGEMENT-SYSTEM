...
public class AddStudent extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submit) {
            ...
            try {
                Conn c = new Conn();
                String q = "INSERT INTO student (name, fname, rollno, dob, address, phone, email, class_x, class_xii, aadhar, course, branch) " +
                        "VALUES ('" + name + "', '" + father + "', '" + roll + "', '" + dob + "', '" + address + "', '" + phone + "', '" +
                        email + "', '" + m10 + "', '" + m12 + "', '" + aadhar + "', '" + course + "', '" + branch + "')";
